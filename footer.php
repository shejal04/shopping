    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <p>You can shop for any products from here. It contains many categories and sub categories.</p>
            </div>
            <div class="col-md-3">
                <h3>Categories</h3>
                <ul class="menu-list">
            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    <?php if(!empty($footer[0]['contact_address'])){ ?>
                        <li><i class="fa fa-home" ></i><span>: <?php echo $footer[0]['contact_address']; ?>  Titwala </span></li>
                    <?php } ?>
                    ...
                    <?php if(!empty($footer[0]['contact_email'])){ ?>
                        <li><i class="fa fa-envelope" ></i><span>: <?php echo $footer[0]['contact_email']; ?> shopping@gmail.com</span></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="col-md-12">
