...
curl_setopt($ch, CURLOPT_URL, 'https://docs.instamojo.com/reference/create-a-payment-request-1');
curl_setopt($ch, CURLOPT_HEADER, FALSE);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, TRUE);
curl_setopt($ch, CURLOPT_HTTPHEADER,
            array("X-Api-Key:test_26403ec03cfe0b760700c0f14422d95e",
                  "X-Auth-Token:test_f6fe1a9d607c0bcce748da8cd502e5c0"));
$payload = Array(
